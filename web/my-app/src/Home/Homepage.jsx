                ...
                >
                  ...
                  <div className="h-full w-full flex items-center justify-center">
                    <div className="w-4/5 h-4/5 transition-transform duration-[0.58s] ease group-hover:scale-105">
                      ...
                      >
                        <source
                          src="/GameMovie/tutorial_voice.mp4"
                          type="video/mp4"
                        />
                ...
                >
                  ...
                  <div className="h-full w-full flex items-center justify-center">
                    <div className="w-4/5 h-4/5 transition-transform duration-[0.58s] ease group-hover:scale-105">
                      ...
                      >
                        <source
                          src="/GameMovie/Mission_voice.mp4"
                          type="video/mp4"
                        />
                      </video>
                    </div>
                ...
                >
                  <div className="h-full w-full flex items-center justify-center">
                    <div className="w-4/5 h-4/5 transition-transform duration-[0.58s] ease group-hover:scale-105">
                      ...
                      >
                        <source
                          src="/GameMovie/Freedom_voice.mp4"
                          type="video/mp4"
                        />
                      </video>
                    </div>
